...
public class PostController {
     ...
     */
    @PostMapping("/add")
    public BaseResponse<Long> addPost(@RequestBody InterfaceInfoAddRequest postAddRequest, HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> updatePost(@RequestBody InterfaceInfoUpdateRequest interfaceInfoUpdateRequest,
        ...
        Post post = new Post();
        BeanUtils.copyProperties(interfaceInfoUpdateRequest, post);
        // 参数校验
    ...
    @GetMapping("/list")
    public BaseResponse<List<Post>> listPost(InterfaceInfoQueryRequest interfaceInfoQueryRequest) {
    ...
    public BaseResponse<Page<Post>> listPostByPage(InterfaceInfoQueryRequest interfaceInfoQueryRequest, HttpServletRequest request) {
        if (interfaceInfoQueryRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Post postQuery = new Post();
